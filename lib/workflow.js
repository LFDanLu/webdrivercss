...
function workflow(pagename, args) {
    ...
    var context = {
         ...
         * default attributes
         */
        misMatchTolerance:      currentArgs.misMatchTolerance || this.misMatchTolerance,
        ...
        screenHeight:   currentArgs.screenHeight || [].concat(this.screenHeight),
        ignore:         currentArgs.ignore || this.ignore,
        cb:             cb
    };
